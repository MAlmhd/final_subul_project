...
class CustomTrackShipmentItem extends StatelessWidget {
  const CustomTrackShipmentItem({
    super.key,
    required this.shipmentInTheWayEntity,
  });
  final ShipmentInTheWayEntity shipmentInTheWayEntity;
            ...
            child: Row(
              children: [
                ...
                Tooltip(
                  message: 'عدد الطرود',
                  child: Text(
                    shipmentInTheWayEntity.actualParcelsCount.toString(),
                ...
                Flexible(
                  child: Tooltip(
                    message: 'اسم الزبون',
                    child: Text(
                      shipmentInTheWayEntity.customerName,
                      style: Styles.textStyle5Sp,
                      softWrap: true,
                    ),
                  ),
                ...
                Flexible(
                  child: Tooltip(
                    message: 'رقم التتبع',
                    child: Text(
                      shipmentInTheWayEntity.trackingNumber,
                      softWrap: true,
                      style: Styles.textStyle5Sp,
          ...
          TextButton(
            onPressed: () {
              context.pushNamed(
                ...
                arguments: shipmentInTheWayEntity.id,
              );
            },
            style: ButtonStyle(
