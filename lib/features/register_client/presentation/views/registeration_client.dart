...
import 'package:final_subul_project/core/widgets/custom_text_field.dart';
...
import 'package:final_subul_project/features/register_client/presentation/manager/get_companies_cubit/get_companies_cubit.dart';
import 'package:final_subul_project/features/register_client/presentation/manager/register_client_cubit/register_client_cubit.dart';
import 'package:final_subul_project/features/register_client/presentation/views/widgets/company_picker.dart';
      ...
      child: BlocConsumer<RegisterClientCubit, RegisterClientState>(
        listener: (context, state) {
          ...
          if (state is RegisterClientSuccess) {
            showToastMsg(context, state.registerClientEntity.message,);
            clearForm();
          }
        },
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      if (profileImage == null) {
                         showToastMsg(context, "يرجى إدخال صورتك الشخصية");
                        return;
                      }

                      if (identityImage == null) {
                        showToastMsg(context, "يرجى إدخال صورتة الهوية");
                        return;
                      }

                      if (selectedCompanyId == null) {
                        showToastMsg(context, "يرجى اختيار الشركة");
                        return;
                      }
