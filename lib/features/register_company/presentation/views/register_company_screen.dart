...
import 'package:final_subul_project/features/register_company/presentation/manager/register_company_cubit/register_company_cubit.dart';
      ...
      child: BlocConsumer<RegisterCompanyCubit, RegisterCompanyState>(
        listener: (context, state) {
          ...
          if (state is RegisterCompanySuccess) {
             showToastMsg(context,state.registerCompanyEntity.message,);
            clearForm();
          }
        },
