...
import 'package:final_subul_project/features/show_companies_and_clients/presentation/manager/delete_user_cubit/delete_user_cubit.dart';
import 'package:final_subul_project/features/show_companies_and_clients/presentation/manager/show_companies_and_clients_cubit/show_companies_and_clients_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create:
              (_) => ShowCompaniesAndClientsCubit(
      ...
      child: BlocListener<DeleteUserCubit, DeleteUserState>(
        listener: (context, deleteState) {
          if (deleteState is DeleteUserSuccess) {
             showToastMsg(context, "تم الحذف بنجاح");
            context
                .read<ShowCompaniesAndClientsCubit>()
                .showCompaniesAndClients();
          } else if (deleteState is DeleteUserFailure) {
             showToastMsg(context, deleteState.message,);
          }
        },
        child: BlocBuilder<
          ShowCompaniesAndClientsCubit,
          ShowCompaniesAndClientsState
        >(
